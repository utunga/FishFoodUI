...
namespace FishFoodUI
{
    ...
    /// rectangle drawing.
    /// </summary>
    public class RectangleDrawingSpriteBatch : SpriteBatch
    {
        /// <summary>
        ...
        public RectangleDrawingSpriteBatch(GraphicsDevice graphicsDevice)
            : base(graphicsDevice)
        {
        ...
        public void DrawLine(Vector2 start, Vector2 end, Color color)
        {
            ...
            this.Draw(this.WhiteTexture, start, null, color, rotation, Vector2.Zero, new Vector2(length, 1),
